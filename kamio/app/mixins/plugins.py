...
class PluginFacadeMixin:
    ...
    async def load_plugin(self: Any, plugin_class, config: Optional[Dict[str, Any]] = None):
        ...
        Args:
            plugin_class: A :class:`Plugin` subclass to instantiate.
    ...
    def list_plugins(self: Any) -> List[str]:
        ...
        Returns:
            A list of plugin name strings.
        """
        result: List[str] = self.plugin_loader.list_plugins()
        return result
